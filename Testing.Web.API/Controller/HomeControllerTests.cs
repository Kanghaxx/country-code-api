...
namespace Testing.Web.API.Controller
{
    ...
    public class HomeControllerTests
    {
        ...
        public void Get_Returns_Endpoints()
        {
            ...
            urlHelper.Setup(m => m.Content("~/api/login")).Returns("/api/login");
            ...
            Assert.IsTrue(contentResult.Content.Endpoints.Count() == 5);
            ...
            Assert.IsTrue(contentResult.Content.Endpoints["GetOAuthToken"] == "/api/login");
